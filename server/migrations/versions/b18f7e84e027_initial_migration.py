...
Revision ID: b18f7e84e027
Revises: 
Create Date: 2024-07-08 17:39:19.260097
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], name=op.f('fk_channels_creator_id_users')),
    sa.PrimaryKeyConstraint('id')
    )
